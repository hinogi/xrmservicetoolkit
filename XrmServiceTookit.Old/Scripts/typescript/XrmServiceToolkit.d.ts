    ...
    */
    export module Rest
    {
        ...
        */
        ...
        export function Retrieve( id: string, type: string, select: string, expand: string, successCallback: ( entity: Entity ) => void , errorCallback: ( error: Error ) => void , async: boolean );
        export function Update( id: string, object: Entity, type: string, successCallback: () => void , errorCallback: ( error: Error ) => void , async: boolean );
        export function Delete( id: string, type: string, successCallback: () => void , errorCallback: ( error: Error ) => void , async: boolean );
        export function RetrieveMultiple( type: string, options: string, successCallback: ( entities: Entity[] ) => void , errorCallback: ( error: Error ) => void , onComplete: () => void , async: boolean );
        export function Associate( entityid1: string, odataSetName1: string, entityid2: string, odataSetName2: string, relationship: string, successCallback: () => void , errorCallback: ( error: Error ) => void , async: boolean );
        export function Disassociate( entityid1: string, odataSetName: string, entityid2: string, relationship: string, successCallback: () => void , errorCallback: ( error: Error ) => void , async: boolean );
    }
